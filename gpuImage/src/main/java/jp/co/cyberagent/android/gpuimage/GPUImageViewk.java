...
public class GPUImageViewk extends FrameLayout {
    ...
    public GPUImageViewk(Context context) {
        super(context);
        init(context, null);
    }

    public GPUImageViewk(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * {@link GPUImageViewk#updatePreviewFrame(byte[], int, int)} frame by frame
     * <p>
